...
export default function InvoicePLNNon() {
  ...
  return (
    <PageContainer
      title="PLN Non Detail Payment"
      description="PLN Non Detail Payment"
    >
      <Grid container spacing={3}>
        <Grid item sm={12}>
          <DashboardCard title="Detail Payment Non Tags">
            <div className="px-6">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-4">
                        {isLoading ? (
                          ...
                          PaymentData.registrationnumber || "N/A"
                        )}
                      </td>
                      <td className="py-4 px-4">
                        {isLoading ? (
