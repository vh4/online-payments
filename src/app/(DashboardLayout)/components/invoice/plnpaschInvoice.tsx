...
export default function InvoicePLNPasch() {
  ...
  return (
    <PageContainer title="PLN Postpaid Detail Payment" description="PLN postpaid detail payment">
      <Grid container spacing={3}>
        <Grid item sm={12}>
          <DashboardCard title="PLN Postpaid Detail Payment">
            <div className="px-6">
                    ...
                    <tr className="border-b">
                      ...
                      <td className="py-4 px-4">
                        {isLoading ? (
                          ...
                          PaymentData.subscribername || "N/A"
                        )}
                      </td>
                      <td className="py-4 px-4">
                        {isLoading ? (
                          ...
                          `${PaymentData.subscribersegmentation || "N/A"} / ${
                      ...
                      <td className="py-4 px-4">
                        {isLoading ? (
                          ...
                          `${PaymentData.slalwbp1} - ${PaymentData.sahlwbp1}`
                        )}
                      </td>
                      <td
