...
export default function PlnForm() {
  ...
  const [selectedMailingList, setSelectedMailingList] = useState<string | null>(
    "Prepaid"
  );
    ...
    try {
      ...
      if (pilih == 1) {
        ...
        if (result.status != "00") {
          ...
          setLoading(false);
          router.push(`/menu/pln/categories/plnpra`);
        }
        ...
        if (result.status != "00") {
          ...
          dispatch(setInquiry(result));
          setLoading(false);
          router.push(`/menu/pln/categories/plnpasch`);
        }
        ...
        if (result.status != "00") {
          ...
          dispatch(setInquiry(result));
          setLoading(false);
          router.push(`/menu/pln/categories/plnnon`);
        }
      }
    } catch (error) {
      toaster.push(
      ...
      <Grid container spacing={3}>
        <Grid item sm={12}>
          <DashboardCard title="Purchase Token or Pay Electricity Bill.">
            <div className="px-4 pt-6 pb-12rounded-lg">
              <Form
